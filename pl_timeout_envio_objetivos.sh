...
#echo "Procesos pl_timeout_envio_objetivos.sh levantados -> $NUM_SESION"
...
cat>$SHELL_PATH/plan_negocios_timeout_envio_objetivos.sql<<END
set heading off
begin
   gck_trx_plan_negocios_jobs.GCP_TIMEOUT_ENVIO_OBJETIVOS;
end;
/
exit;
END
...
rm -f $SHELL_PATH/plan_negocios_timeout_envio_objetivos.sql
